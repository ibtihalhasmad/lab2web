...
if (isset($_POST['signup'])) {
    ...
    try {
        ...
        if (file_exists($_FILES["image"]["tmp_name"]) || is_uploaded_file($_FILES["image"]["tmp_name"])) {
            ...
            echo "<script>window.location.replace('myhome.php')</script>";
        }
    } catch (PDOException $e) {
        echo "<script>alert('Failed')</script>";
        echo "<script>window.location.replace('mytutor.php')</script>";
    }
...
<link src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="../css/mytutor.css">
...
<body body onload="loadCookies()">
  ...
  <h2> MY TUTOR WEBSITE </h2>
	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form action="mytutor.php" method="post" enctype="multipart/form-data" >
                ...
                <img src="../image/photos/images.png" id="image" width="100">
		...
		<div class="form-container sign-in-container" style="text-align:left;">
			<form name="loginform" action="mytutor.php" name="rememberMe" method="post">
				<h1>Sign in</h1>
				<input type="email" name="email" id="idemail" placeholder="Eenter your email" required />
	...
	<script type="text/javascript" src="../js/mytutor.js"></script>
</body>
